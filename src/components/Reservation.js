    ...
    <section className="relative top-96 z-30 pb-20 lg:py-[100px]">
      <div className="container mx-auto">
        ...
        <motion.form
          ...
          whileInView={"show"}
        >
          <div className="flex flex-col lg:flex-row gap-y-4 items-center justify-between mb-10">
            {/* date picker */}
            <div>
            ...
            <div>
              <div>
                ...
                <input className="input" type="number" placeholder="1"></input>
              </div>
            </div>
          </div>
          {/* button */}
